...
function requireVendor(req, res, next) { if (req.user.role !== 'vendor') return next(new AppError('This page is available to vendors only.', 403)); next(); }
module.exports = { requireLogin, requirePatron, requireVendor };
